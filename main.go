...
var todos = []Todo{
	{ID: 1, Description: "Do food preparation", Completed: true},
	{ID: 2, Description: "Cook for breakfast", Completed: true},
	{ID: 3, Description: "Do daily-work task", Completed: false},
	{ID: 4, Description: "Study for exams", Completed: false},
	{ID: 5, Description: "Write summary in notion", Completed: false},
}
...
func main() {
	...
	// Run the Gin-Gonic server on port 8070.
	r.Run(":8070")
}
